    ...
    const onDeletePress = async () => {
      try {
        if (mode === "chat") {
          ...
          setGroupChats((currentGroupChats) =>
            currentGroupChats.filter(
              (groupchat) => groupchat.group_chat_id !== chatId,
            ),
          );
        }
      } catch (error) {
      ...
      <View style={styles.radioButtonContainer}>
        <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
          <TouchableOpacity
            style={[
              styles.radioButton,
              mode === "chat" ? styles.radioButtonSelected : {},
            ]}
          ...
          >
            <Text
              style={[
                ...
                mode === "chat" ? styles.radioButtonLabelSelected : {},
              ]}
            >
              Chats
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.radioButton,
              mode === "group-chat" ? styles.radioButtonSelected : {},
            ]}
            onPress={() => setMode("group-chat")}
          >
            <Text
              style={[
                styles.radioButtonLabel,
                mode === "group-chat" ? styles.radioButtonLabelSelected : {},
              ]}
            >
              Group Chats
            </Text>
          ...
          {mode === "chat"
            ? chats.map((chat) => (
                <Swipeable
                  ...
                  renderRightActions={(progress, dragX) =>
                    renderRightActions(progress, dragX, chat.chat_id)
                  }
                >
                  <Chat chat={chat} />
                </Swipeable>
            ...
            : groupchats.map((groupchat) => (
                <Swipeable
                  ...
                  renderRightActions={(progress, dragX) =>
                    renderRightActions(progress, dragX, groupchat.group_chat_id)
                  }
                >
