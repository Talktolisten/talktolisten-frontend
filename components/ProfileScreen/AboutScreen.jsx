    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.infoContainer}>
        <Text style={styles.paragraph}>
          We want to create an innovative platform that allows users to engage
          in lifelike conversations with AI-powered characters
        </Text>
        <View style={styles.infoLogoContainer}>
          <TouchableOpacity
            onPress={() => Linking.openURL(LINKS.TTLWebsite)}
