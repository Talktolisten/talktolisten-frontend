        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          {isSubmitted ? (
            <Text style={styles.paragraph}>
              We greatly appreciate your feedback! Your input is crucial in
              helping us continually improve our services. Thank you for taking
            ...
            >
              <View style={styles.infoContainer}>
                <Text style={styles.paragraph}>
                  Help us shape the future of our platform. Your insights are
                  invaluable to us.
                </Text>
              </View>
